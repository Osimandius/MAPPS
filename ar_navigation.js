...
function render_elements() {
    $.ajax({
        ...
        success: function (respose) {
            console.log(respose)
            let steppeis = respose.routes[0].legs[0].steps
            ...
            for (let i = 0; i < steppeis.length; i++) {
                let image;
                let distance = steppeis[i].distance
                let instruction = steppeis[i].maneuver.instruction
